...
/**
 * Classe que representa um jogador que tem como características um ID(para identificar cada jogador),
 * nome, idade, preço, país de origem e posição no time.
 * Apresenta também um valor para suas habilidades(chute, passe, defender, velocidade, blefe e drible).
 * Possui métodos getters para tods os seus atributos e não possui setter, pois uma vez criado,
 * o jogador não tem suas características nem suas habilidades alteradas.
...
public class Jogador {
    ...
    /**
     * Construtor que recebe todos os atributos de um jogador como parâmetro e faz a chamada do método setAll(),
     * recebe inclusive o ID 
    ...
    /**
     * Construtor que recebe todos os atributos de um jogador como parâmetro e faz a chamada do método setAll(),
     * recebe exceto o ID, este é tratado dentro do próprio construtor 
     * @param ID ID é o número de indentificação de cada jogador
     * @param nome nome do jogador
     * @param idade idade do jogador
     * @param preco preço que o jogador terá dentro do jogo
     ...
     * @return retorna um objeto Jogador com os mesmo valores do objeto que chamou o método
     */
    ...
    /**
     * Método que verifica o valor atribuido a uma detrminada habilidade de um jogador.
     * Os valores permitidos estão entre 0 e 100, ou seja, se uma habilidade foi passada com um valor superir a 100
     * ou inferior a 0, ela simplesmente retorna o valor um dos seus extremos.
     * @param habilidade pode ser passado qualquer habilidade de um jogador (chute, passe, velocidade, etc)
     * @return retorna 0 caso tenha sido passado um valor inferior a 0, retorna 100 se o valor é superior a 100 ou retorna o valor passado, 
     * e que está dentro intervalo permitido
     */
    ...
    /**
     * Método que auxilia o construtor na hora de inicializar um objeto, é o método responsável por atribuir os valores
     * de cada atributo da classe, exceto o ID. 
     * Deste modo, recebe como parâmetro todos os parâmetros recebidos pelo construtor, exceto ID, e chama o método
     * verificarHabilidade() para que os valores atribuídos em cada atributo esteja correto. 
     */
